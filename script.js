var responses = {
    ...
    "pau": "Pau é uma comuna francesa situada no departamento dos Pirenéus Atlânticos, na região da Nova Aquitânia.",
    "pinto": "Pinto é um município da Espanha na província e Comunidade de Madrid. Faz parte da área metropolitana de Madrid, tem 61,9 km² de área e em 2021 tinha 53 537 habitantes.",
    "sexo é bom": "Com sua mãe é melhor ainda",
    "tua mãe é gorda": "A sua é um planeta",
    "tua mãe é um planeta": "A sua é o universo inteiro",
    "tua mãe é um universo": "A sua é maior que a da minha",
    "tua mãe aquela puta": "A sua dá pra monte de mulher e fala pro seu pai pra comprar o leite e o cigarro",
    "bosta": "💩",
    "cocô": "Infantil demais...",
    "coco": "🥥",
    "água": "💦",
    "tem vaga pra adm": "Você nem é, pra ser tem que ser importante no servidor do Discord e ainda tem que ser aprovado no site pra ser adm.",
    "HTML": "Do nada",
    "me ensina Python": "Eu tenho meu irmão, ele se chama ChatGPT",
    "por que minha conversa não fica salva?": "Porque não tem como criar conta?",
    "❤": "💔",
    "💔": "💝: Mr. Bombastic, Bomba Fantastic.",
    "vem dj lorran": "Na treta do DJ Lorran ele me fode com pressão.",
    "tem comandos": "Tem: /troll",
    "/troll": "Parabéns! Você ganhou 10 de XP por ter trolado seu amigo com um rickroll, use /xp pra ver o seu xp",
    "/xp": "Você não tinha ganhado XP, te trolei, fiz a minha vingança meu amigo",
    "Spotify": "SoundCloud é melhor",
    "SoundCloud": "Spotify é melhor",
    "Spotify ou SoundCloud?": "YouTube Music é muito melhor",
    "YouTube Music": "Acabou a graça também",
    "2015": "5491 só que 💫",
    "tob 👍": "Foof",
    "o que é foof?": "Fodase",
    "Fodase?": "Fodase meu mano",
    "namoral": "namoral",
    "Que horas são?": "Hora de ir pra casa do carai",
    "foof": "Blowjoob",
    "cock": "booost",
    "loki": "Cuzin",
    "jooj": "uTorrent",
